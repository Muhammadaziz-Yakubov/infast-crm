...
const ConfirmDialog = ({ isOpen, onClose, onConfirm, title, message, confirmText = "O'chirish", type = 'danger' }) => {
    ...
    const content = (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            <div className="fixed inset-0 bg-black/80 backdrop-blur-md modal-overlay" onClick={onClose} />
            <div className="relative w-full max-w-sm bg-white dark:bg-dark-800 rounded-[2.5rem] shadow-3xl modal-content p-8 md:p-10 border border-white/10 z-[10000]">
